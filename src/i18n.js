...
export const translations = {
  de: {
    ...
    'module.shape-build': 'Formen-Werkstatt',
    'module.board': 'Lumis Spielbrett',
    'module.empathy': 'Gefühlsdetektiv',
  ...
  en: {
    ...
    'module.shape-build': 'Shape Workshop',
    'module.board': 'Lumis Board Game',
    'module.empathy': 'Feelings Detective',
