...
const LANGUAGES = [
  ...
  },
  {
    ...
    flag: '🇬🇧',
    name: 'English',
    sub: 'Learn in English',
    gradient: 'linear-gradient(135deg, #4ECDC4, #0099F7)',
    shadow: 'rgba(0,153,247,0.35)',
  },
]
        ...
        {LANGUAGES.map((lang, i) => {
          ...
          return (
            ...
            >
              ...
              <span style={{ fontFamily: 'var(--font-heading)', fontSize: 24, color: 'white', fontWeight: 600 }}>
                {lang.name}
              </span>
